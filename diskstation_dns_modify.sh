...
YourNetworkName=home.local
ForwardMasterFile=home.local
ReverseMasterFile=0.168.192.in-addr.arpa
...
overridesettings(){
  ...
  if [ -r $settingsfile ]; then
	...
	date_echo "Settings file should be located in: $settingsfile"
  fi
}
...
BackupPath=/var/services/homes/admin/scripts/synology_dhcp_dns_autoupdate/dns_backups
